...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        var e = Math.PI / 180,
            ...
            d = function(r, n, o, i, a, s, h, l, f) {
                if (r !== l || n !== f) {
                    ...
                    var F, j, H, D = p(O, R),
                        ...
                        W = u * i,
                        Z = D.length - 2;
                    for (F = 0; Z > F; F += 2) j = D[F], H = D[F + 1], D[F] = j * Q + H * U + G, D[F + 1] = j * E + H * W + L;
            ...
            m = function(e) {
                ...
                for (t = 0; A > t; t++)
                    ...
                    for (m = d(C, S, 1 * b[t + 1], 1 * b[t + 2], 1 * b[t + 3], 1 * b[t + 4], 1 * b[t + 5], (h ? C : 0) + 1 * b[t + 6], (h ? S : 0) + 1 * b[t + 7]), n = 0; n < m.length; n++) l[y++] = m[n];
                    C = l[y - 2], S = l[y - 1], t += 7
            ...
            F = _gsScope._gsDefine.plugin({
                ...
                init: function(e, t, r, n) {
                    ...
                    } : "d" === a ? L(t.shapeIndex, t.map || F.defaultMap, t.precompile) : B(t.shapeIndex)), s && (this._overwriteProps.push("morphSVG"), s.end = p, s.endProp = a)), u)) : (c("WARNING: cannot morph a <" + o + "> SVG element. " + R), !1)) : (window.location.href = "http://" + f + g + "?plugin=" + l + "&source=" + h, !1)
                },
                set: function(e) {
                    var t;
        ...
        F.pathFilter = G, F.pointsFilter = Y, F.subdivideRawBezier = v, F.defaultMap = "size", F.pathDataToRawBezier = function(e) {
            return m(O(e, !0))
        }, F.equalizeSegmentQuantity = T, F.convertToPath = function(e, t) {
            "string" == typeof e && (e = s.selector(e));
            for (var r = e && 0 !== e.length ? e.length && e[0] && e[0].nodeType ? Array.prototype.slice.call(e, 0) : [e] : [], n = r.length; --n > -1;) r[n] = X(r[n], t !== !1);
            return r
