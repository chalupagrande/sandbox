...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function l(a) {
        if (!a) return 0;
        a = j(a);
        var d, e, f, g, h, k, l, c = a.tagName.toLowerCase();
        if ("path" === c) {
    ...
    c = _gsScope._gsDefine.plugin({
        ...
        init: function(a, b, c) {
            ...
            var j, n, o, i = l(a) + 1;
            return this._style = a.style, b === !0 || "true" === b ? b = "0 100%" : b ? -1 === (b + "").indexOf(" ") && (b = "0 " + b) : b = "0 0", j = m(a, i), n = k(b, i, j[0]), this._length = i + 10, 0 === j[0] && 0 === n[0] ? (o = Math.max(1e-5, n[1] - i), this._dash = i + o, this._offset = i - j[1] + o, this._addTween(this, "_offset", this._offset, i - n[1] + o, "drawSVG")) : (this._dash = j[1] - j[0] || 1e-6, this._offset = -j[0], this._addTween(this, "_dash", this._dash, n[1] - n[0] || 1e-5, "drawSVG"), this._addTween(this, "_offset", this._offset, -n[0], "drawSVG")), h
        },
        set: function(a) {
